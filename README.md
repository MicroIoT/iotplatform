...
- MicroIoT物联网平台支持快速定义任意类型“物”。对定义的各种类型“物”，实时生成监控界面，实时模拟生成数据，极大提高物联网应用开发的效率。
- MicroIoT物联网平台从业务和应用的角度出发设计系统，对用户隐藏技术细节，用户完全不需要关心底层的物联网通信协议，不需要关心订阅消息主题，极大降低物联网应用开发的门槛。
