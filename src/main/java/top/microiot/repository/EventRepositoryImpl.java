...
public class EventRepositoryImpl implements CustomEventRepository {
	...
	@Override
	public Page<Event> queryEvent(String domainId, String deviceId, String attribute, Date reportFrom, Date reportTo, Date receiveFrom, Date receiveTo, Pageable pageable) {
		...
		if(receiveFrom != null && receiveTo != null){
		...
		return page.getPage(Event.class, query, pageable);
	}
